...
import { NoxFormFieldGroupComponent } from './nox-form-field-group.component';
...
@Component({
  selector: 'nox-form-items',
  template: ""
})
export class NoxFormItemsComponent implements AfterContentInit {
